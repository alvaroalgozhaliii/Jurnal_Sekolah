...
Route::post('/login-guru', [LoginGuruController::class, 'login'])
    ->name('guru.login.proses');

Route::get('/dashboard-guru', [LoginGuruController::class, 'dashboard'])
    ->name('dashboard.guru');

Route::post('/logout-guru', [LoginGuruController::class, 'logout'])
    ->name('guru.logout');
...
Route::post('/login-siswa', [LoginSiswaController::class, 'login'])
    ->name('siswa.login.proses');

Route::get('/dashboard-siswa', [LoginSiswaController::class, 'dashboard'])
    ->name('dashboard.siswa');

Route::post('/logout-siswa', [LoginSiswaController::class, 'logout'])
    ->name('siswa.logout');
